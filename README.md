...
## 1
* add loading spinner everywhere it's needed and verify the redirections
* make the upload form available for logged user only

## 2
* home page: contain all images from everyone
