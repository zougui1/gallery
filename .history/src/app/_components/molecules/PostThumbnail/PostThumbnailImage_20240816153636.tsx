  ...
  return (
    <div
      className={cn(
        ...
        post.rating === PostRating.sfw && 'border-gray-600/70 shadow-gray-700/80 hover:shadow-gray-700/80',
        post.rating === PostRating.nsfw && 'border-red-600/70 shadow-red-700/80 hover:shadow-red-700/80',
