...
export const PostThumbnailImage = ({ selected }: PostThumbnailImageProps) => {
  ...
  return (
    <div
      className={cn(
        ...
        selected && 'border-4 border-purple-600/90 shadow-purple-700 hover:shadow-purple-700',
      )}
    >
      <picture>
...
export interface PostThumbnailImageProps {
  selected?: boolean;
}
