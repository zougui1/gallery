        ...
        <div className="flex gap-4 flex-wrap">
          {posts.map(post => (
            <div key={post._id} className="flex justify-center items-center relative">
              ...
              <Link href="#" className="relative h-fit">
                <picture>
                  ...
                  <img
                    ...
                    className={cn(
                      ...
                      'hover:brightness-90 hover:shadow-md hover:scale-[1.01]',
                      post.rating === PostRating.sfw && 'shadow-gray-600 hover:shadow-gray-600',
                      post.rating === PostRating.nsfw && 'shadow-red-600 hover:shadow-red-600',
                    )}
                  />
                </picture>
