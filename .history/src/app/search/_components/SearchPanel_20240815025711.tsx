...
export const SearchPanel = () => {
  ...
  return (
    <MainLayout.SidePanel className="max-w-80 w-full flex flex-col gap-6">
      <div>
      ...
      <div className="w-full flex flex-col">
        ...
        <div className="flex flex-wrap *:w-1/3">
          <label>
            <input type="checkbox" checked={types.includes(PostType.image)} onChange={() => toggleType(PostType.image)} />
            <span className="ml-2 capitalize">{PostType.image}</span>
          </label>
          ...
          <label>
            <input type="checkbox" checked={types.includes(PostType.animation)} onChange={() => toggleType(PostType.animation)} />
            <span className="ml-2 capitalize">{PostType.animation}</span>
          </label>
        </div>
      </div>
