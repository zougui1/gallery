  ...
  return (
    ...
    >
      <Link
        href={`/posts/${post._id}`}
        className={cn(
          'relative border border-shadow rounded-md transition-all max-w-full block',
          'hover:brightness-90 hover:shadow hover:scale-[1.02]',
          post.rating === PostRating.sfw && 'shadow-gray-600/75 hover:shadow-gray-600/50',
          post.rating === PostRating.nsfw && 'border-red-600/50 shadow-red-500/75 hover:shadow-red-500/50',
        )}
      >
        <picture>
