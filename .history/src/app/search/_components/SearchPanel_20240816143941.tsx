    ...
    <MainLayout.SidePanel className="md:max-w-80 w-full space-y-4">
      ...
      <div>
        ...
        <div className="flex flex-wrap *:w-1/2">
          <label>
            <input type="radio" checked={ratings.includes(PostRating.sfw)} onChange={() => toggleRating(PostRating.sfw)} />
            <span className="ml-2">{PostRating.sfw.toUpperCase()}</span>
          </label>

          <label>
            <input type="radio" checked={ratings.includes(PostRating.nsfw)} onChange={() => toggleRating(PostRating.nsfw)} />
            <span className="ml-2">{PostRating.nsfw.toUpperCase()}</span>
          </label>
        </div>
