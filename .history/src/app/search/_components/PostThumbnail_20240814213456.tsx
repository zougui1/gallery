  ...
  return (
    ...
    >
      <Link
        href={`/posts/${post._id}`}
        className={cn(
          'relative border shadow-[0px_2px_6px_var(--tw-shadow-color)] rounded-md transition-all max-w-full block',
          'hover:brightness-90 hover:shadow-[0px_2px_8px_var(--tw-shadow-color)] hover:scale-[1.02]',
