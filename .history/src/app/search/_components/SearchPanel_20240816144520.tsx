...
export const SearchPanel = () => {
  ...
  const [navigationType, setNavigationType] = useState<NavigationType>(NavigationType.links);
    ...
    <MainLayout.SidePanel className="md:max-w-80 w-full space-y-4">
      ...
      <div>
        ...
        <div className="flex flex-wrap *:w-1/2">
          <label>
            <input type="radio" checked={navigationType === NavigationType.links} onChange={() => setNavigationType(NavigationType.links)} />
            <span className="ml-2">{NavigationType.links}</span>
          </label>

          <label>
            <input type="radio" checked={navigationType === NavigationType.selection} onChange={() => setNavigationType(NavigationType.selection)} />
            <span className="ml-2">{NavigationType.selection}</span>
          </label>
        </div>
