  ...
  return (
    <HydrateClient>
      <MainLayout.Body className="*:h-full">
        ...
        {posts.length > 0 && (
          <div className="flex flex-col gap-6 h-full shadow-inner shadow-red-600">
            <div className="flex justify-center gap-4 flex-wrap md:max-h-[calc(100vh-180px)] overflow-y-auto">
              {posts.map(post => (
