      ...
      <MainLayout.Body className="*:h-full">
        ...
        {posts.length > 0 && (
          <div className="flex flex-col gap-6 h-full">
            <div className="relative flex justify-center gap-4 flex-wrap md:max-h-[calc(100vh-180px)] overflow-y-auto shadow-inner shadow-black/30 shadow-red-500 pt-2">
              <div className="w-full fixed top-0 bg-blue-500 border border-yellow-500"></div>
              {posts.map(post => (
