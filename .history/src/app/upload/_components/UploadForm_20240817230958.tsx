...
const alts = [
  {
    ...
    keywords: ['dragon', 'cum', 'bondage', 'rough', 'sex', 'dick', 'pussy', 'straight', 'dom', 'sub', 'pet', 'master', 'pet-play'],
    title: 'Teaching my pet how to be a good girl - cum alt',
    description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer consectetur ultricies enim at malesuada. Sed egestas ligula eu lacinia rutrum. Fusce hendrerit tortor nec varius semper. Sed facilisis fringilla tortor, vel dapibus urna accumsan sed. Suspendisse sed eros at lorem eleifend interdum. Nullam sapien sapien, iaculis sed ipsum eu, pharetra tincidunt dui. Curabitur accumsan id mi ut efficitur. Vestibulum tempus ultricies feugiat. Morbi eget ex neque. ',
