...
export const AltFormDialog = ({ children, onSubmit, defaultValue }: AltFormDialogProps) => {
  const form = useForm<z.infer<typeof submissionUploadSchema.asAlt>>({
...
export interface AltFormDialogProps {
  ...
  onSubmit: (data: z.infer<typeof submissionUploadSchema.asAlt>) => void;
  defaultValue?: z.infer<typeof submissionUploadSchema.asEither>;
}
