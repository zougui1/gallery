...
export const SingleSubmissionForm = () => {
  const form = useForm<z.infer<typeof submissionUploadSchema>>({
    resolver: zodResolver(submissionUploadSchema),
    defaultValues: {
      description: '',
      keywords: [],
      title: '',
  ...
  const [alts, setAlts] = useState<z.infer<typeof submissionUploadSchema>[]>([]);
