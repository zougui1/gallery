        ...
        {keywords.slice().sort().map(keyword => (
          <li key={keyword} className="flex justify-between">
            ...
            <div className="flex items-center">
              ...
              {keywordsStatus[keyword] === Status.loading && <Loader xlinkTitle="test" className="w-4 h-4 m-1.5" />}
              {keywordsStatus[keyword] === Status.error && <CircleAlert xlinkTitle="test" className="w-4 h-4 m-1.5" />}
            </div>
          </li>
        ))}
      </ul>
