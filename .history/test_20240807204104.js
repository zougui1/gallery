...
const hashImage = async (filePath, width) => {
  const sharpener = sharp(filePath)
...
(async () => {
  ...
  console.log('original/downscaled-original:', leven.get(original.hash, await hashImage(original.fileName)))
})();
