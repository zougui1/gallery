export declare enum PostQueueStatus {
    /**
     * pseudo status
     */
    idle = "idle",
...
export declare const postQueueStatusLabelMap: Record<PostQueueStatus, string>;
export declare const postQueueStatusValues: [PostQueueStatus, ...PostQueueStatus[]];
export declare const permanentlyDeletableStatuses: PostQueueStatus[];
export declare const deletableStatuses: PostQueueStatus[];
export declare const busyStatuses: PostQueueStatus[];
//# sourceMappingURL=PostQueueStatus.d.ts.map